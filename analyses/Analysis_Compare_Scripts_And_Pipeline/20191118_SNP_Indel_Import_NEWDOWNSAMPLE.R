...
dir.output <- "/DATA/usr/n.klaassen/projects/SuRE_K562/data/interim/SuRE_Indels_gDNA_Count_NewDownsample/"
  ...
  for (chrom in c(1:22, "X")){
    ...
    for (parent in c("equal", "maternal", "paternal")){
      ...
      # testing testing testing testing downsampling
            ...
            downsample.k562.42.1 <- readRDS(file = "/DATA/usr/n.klaassen/projects/SuRE_K562/data/interim/R_Objects/downsampling.vectors/SuRE42_1.K562.downsample.vector.20191118.RDS")
            downsample.hepg2.42.1 <-readRDS(file = "/DATA/usr/n.klaassen/projects/SuRE_K562/data/interim/R_Objects/downsampling.vectors/SuRE42_1.HepG2.downsample.vector.20191118.RDS")
            downsample.hepg2.43.1 <-readRDS(file = "/DATA/usr/n.klaassen/projects/SuRE_K562/data/interim/R_Objects/downsampling.vectors/SuRE43_1.HepG2.downsample.vector.20191118.RDS")
    ...
    saveRDS(sure.snp_indel.allparent, file = paste0(dir.output, replicate, "combined/","sure.",  rep.str , ".counts.snp_indel.", chrom, ".RDS"))
    
    
    } ### END LOOP CHROM 1:22,X ###
  
  # check whether downsampling was correct:
  saveRDS(object = data.frame(rowsum.counts, rowsum.cdna1, rowsum.cdna2, rowsum.cdna3, rowsum.cdna4, rowsum.cdna5, row.names ="total counts"), file = paste0(dir.output, replicate, "downsampled.read.totals.RDS"))
  saveRDS(object = data.frame(rowsumaftersplit.counts, rowsumaftersplit.cdna1, rowsumaftersplit.cdna2, rowsumaftersplit.cdna3, rowsumaftersplit.cdna4, rowsumaftersplit.cdna5, row.names ="total counts after split"), file = paste0(dir.output, replicate, "downsampled.after.split.read.totals.RDS"))
...
file.input.name <- "/DATA/usr/n.klaassen/projects/SuRE_K562/data/interim/SuRE_Indels_gDNA_Count_NewDownsample/SuRE"
dir.output <- "/DATA/usr/n.klaassen/projects/SuRE_K562/data/interim/SuRE_Indels_gDNA_Count_NewDownsample/SuRE_combined/"
