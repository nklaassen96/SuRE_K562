...
dir.input  = "/DATA/usr/n.klaassen/projects/SuRE_K562/data/interim/SuRE_Indels_gDNA_Count_NewDownsample/SuRE_combined/sure.snp_indel.combined.chrom."
dir.output = "/DATA/usr/n.klaassen/projects/SuRE_K562/data/interim/SuRE_Indels_pvalue_NewDownsample/"
...
for (i in c(1:22,"X")){
  ...
  # 1. Define data
  dir.input <- "/DATA/usr/n.klaassen/projects/SuRE_K562/data/interim/SuRE_Indels_pvalue_NewDownsample/sure.snp_indel.dataframe.pvalue.chrom."
...
file.name <- paste0(dir.output, "sure.snp_indel.dataframe.pvalue.all.20191118.RDS")
